                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`rounded-full px-2 py-0.5 text-[10px] font-black ${job.source_platform === 'boss' || !job.source_platform ? 'bg-secondary text-primary' : 'bg-info/10 text-info'}`}>
                      ...
                      {hasActions && (
                        <td className="px-3 py-3" onClick={event => event.stopPropagation()}>
                          <div className="flex flex-wrap items-center justify-center gap-1.5">
                            ...
                            {isExternalPlatform && !jobUrl && (
                              <span className="rounded-lg bg-warning/10 px-2 py-1.5 text-[11px] font-bold text-warning">链接不可用</span>
                            )}
                            {!isExternalPlatform && jobUrl && (
                              <a href={jobUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 rounded-lg border border-card-border px-2 py-1.5 text-[11px] font-bold text-primary hover:bg-secondary">
                            ...
                            {isExternalPlatform && onMarkManuallySent && (
                              <button
                                ...
                                className="inline-flex items-center gap-1 rounded-lg bg-primary px-2 py-1.5 text-[11px] font-bold text-white hover:opacity-90 disabled:bg-success/10 disabled:text-success disabled:opacity-100"
                              >
