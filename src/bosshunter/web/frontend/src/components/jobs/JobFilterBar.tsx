...
export function JobFilterBar({
  ...
  return (
    <div className="mb-4 rounded-2xl border border-card-border bg-surface p-3">
      <div className="grid min-w-0 grid-cols-1 gap-2 md:grid-cols-2 2xl:grid-cols-4">
        ...
        <div className="flex min-h-9 min-w-0 flex-wrap items-center justify-between gap-2 rounded-md border border-card-border bg-card px-3 py-1">
